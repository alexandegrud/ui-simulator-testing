...
@allure.description("Выполнение сортировки таблицы по имени")
@allure.suite("Sorting page")
...
@allure.title("Сортировка по возрасту")
@allure.description("Выполнение сортировки таблицы по возрасту")
@allure.suite("Sorting page")
...
@allure.title("Сортировка по должности")
@allure.description("Выполнение сортировки таблицы по должности")
@allure.suite("Sorting page")
